  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.btnContainer}>
          ...
          <TouchableOpacity onPress={() => changeTabBtn("upcoming")}>
            <View
              style={[
                ...
                {
                  backgroundColor:
                    activeTab === "upcoming" ? Colors.black : Colors.surface_bg,
                },
              ]}
            >
              <Text
          ...
          <TouchableOpacity onPress={() => changeTabBtn("calendar")}>
            <View
              style={[
                ...
                {
                  backgroundColor:
                    activeTab === "calendar" ? Colors.black : Colors.surface_bg,
                },
              ]}
            >
              <Text
        ...
        <TouchableOpacity onPress={() => navigateScreen(Routes.newAppointment)}>
