          ...
          <TouchableWithoutFeedback>
            ...
            >
              ...
              <View style={styles.micBox}>
                <Animated.View
                  style={[styles.pulseCircle, getAnimatedStyle(pulse1)]}
                />
                <Animated.View
                  style={[styles.pulseCircle, getAnimatedStyle(pulse2)]}
                />
                <Animated.View
                  style={[styles.pulseCircle, getAnimatedStyle(pulse3)]}
                />
