...
const chatData: ChatItem[] = [
    ...
    { id: "2", message: "Reminder: Parent-teacher meeting", date: "10 June 2025" },
...
const ChatListScreen: React.FC = () => {
    const renderItem = ({ item }: { item: ChatItem }) => (
        <TouchableOpacity style={styles.eachChat} onPress={() => router.push("/screens/ChatDetails/ChatDetails")}>
