...
const MedicalReport = () => {
  ...
  const tableData = [
    [
      ...
      "Achieve 80% accuracy on 2nd-grade text",
      "75%",
      "Significant progress",
    ],
    [
      "Math Problem Solving",
      "Solve 3-step word problems ",
      "65%",
      "Requires visual scaffolds",
    ],
    [
      "Social Skills",
      "Initiate peer conversation 1x/day",
      "4/5 Days",
      "Teacher reports improved group participation",
    ],
    [
      "Self-Regulation",
      "≤1 meltdown per week",
      "Avg. 1.2/week",
      "Improved with noise-canceling headphones",
    ],
  ];
          ...
          <View style={styles.eachSummary}>
            ...
            <View style={styles.parentRow}>
              ...
              <Text style={styles.label}>
                Happy with progress, requests continued focus on reading fluency
                and social playdates.
              </Text>
            </View>
            <View style={styles.parentRow}>
              <Text style={styles.value}>Teacher Feedback</Text>
              <Text style={styles.label}>
                Reports better classroom participation, but still needs
                redirection during group work.
              </Text>
            </View>
          </View>
          <View style={styles.eachSummary}>
