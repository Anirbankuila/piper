...
import CustomRBSheet, {
  CustomRBSheetRef,
} from "@/app/components/CustomBottomSheet/CustomRBSheet";
    ...
    >
      ...
      <View style={Styles.content}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigateScreen(Routes.faceDetection)}
        >
      ...
      <CustomRBSheet ref={forgotSheetRef} title="Reset Password">
        <View style={{ padding: 10 }}>
          <Text
            style={{ fontFamily: Fonts.Medium, fontSize: 14, marginBottom: 12 }}
          >
...
const Styles = StyleSheet.create({
  ...
  textAndImageWrapper: {
    ...
    justifyContent: "flex-start", // text left, image right
    alignItems: "center",
